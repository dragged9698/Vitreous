package com.dragged9698.vitreous
...
import com.dragged9698.vitreous.exoplayer.ExoPlayerPlugin
import com.dragged9698.vitreous.mpv.MpvPlayerPlugin
import com.dragged9698.vitreous.shared.DeviceQuirks
import com.dragged9698.vitreous.shared.ThemeHelper
import com.dragged9698.vitreous.watchnext.WatchNextPlugin
...
class MainActivity : FlutterActivity() {
  ...
  private val PIP_CHANNEL = "com.vitreous/pip"
  private val EXTERNAL_PLAYER_CHANNEL = "com.vitreous/external_player"
  private val THEME_CHANNEL = "com.vitreous/theme"
  private val DEVICE_CHANNEL = "com.vitreous/device"
  private val DEVICE_ADJUSTMENT_CHANNEL = "com.vitreous/device_adjustment"
  private val TEXT_INPUT_CHANNEL = "com.vitreous/text_input"
  private val APP_EXIT_CHANNEL = "com.vitreous/app_exit"
  private val APP_FOREGROUND_CHANNEL = "com.vitreous/app_foreground"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val prefs = getSharedPreferences("vitreous_prefs", Context.MODE_PRIVATE)
        ...
        "openVideo" -> {
          ...
          try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
              ...
              uri = FileProvider.getUriForFile(this, "com.dragged9698.vitreous.fileprovider", File(path))
              grantRead = true
            }
    ...
    MethodChannel(flutterEngine.dartExecutor.binaryMessenger, THEME_CHANNEL).setMethodCallHandler { call, result ->
      when (call.method) {
        ...
        "setSplashTheme" -> {
          ...
          getSharedPreferences("vitreous_prefs", Context.MODE_PRIVATE)
