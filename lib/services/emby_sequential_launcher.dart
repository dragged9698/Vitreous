...
/// Backend-neutral launcher for Emby collections, playlists, and folders.
///
/// Emby has no server-side queue resource — the client fetches
...
class EmbySequentialLauncher extends MediaListPlaybackLauncher {
  ...
  /// Launch playback from a Emby folder row. Emby has no server-side
  ...
  Future<PlayQueueResult> launchFromFolder({
    ...
    return executeWithLoading(
      ...
      execute: (dismissLoading) async {
        ...
        final fetched = client is EmbyClient
