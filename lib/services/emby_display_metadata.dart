...
MediaDisplayCriteria? embyDisplayCriteriaFromStream(
  ...
  final defaults = _embyDefaultDisplayColorTags(
...
bool embyVideoStreamIsDolbyVision(Map<String, dynamic> videoStream) {
  final profile = embyDolbyVisionProfile(videoStream);
...
int? embyDolbyVisionProfile(Map<String, dynamic> videoStream) => flexibleInt(videoStream['DvProfile']);

bool embyVideoStreamIsHdr(Map<String, dynamic> source, Map<String, dynamic> videoStream) {
  if (embyVideoStreamIsDolbyVision(videoStream)) return true;
  final criteria = embyDisplayCriteriaFromStream(source, videoStream);
...
({String? transfer, String? primaries, String? matrix}) _embyDefaultDisplayColorTags({
