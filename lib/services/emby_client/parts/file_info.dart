...
mixin _EmbyFileInfoMethods on MediaServerCacheMixin {
  @override
  Future<MediaFileInfo?> getFileInfo(MediaItem item) async {
    ...
    return _buildFileInfoFromEmbyItem(itemJson);
  }

  MediaFileInfo? _buildFileInfoFromEmbyItem(Map<String, dynamic> json) {
    ...
    return MediaFileInfo(
      ...
      // Plex stores bitrate as kbps; Emby returns bps. Normalise to kbps.
