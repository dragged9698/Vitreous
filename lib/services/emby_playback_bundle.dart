...
/// Bundle returned by [EmbyClient.fetchPlaybackBundle].
///
/// Threads the data [PlaybackInitializationService] needs out of a single
/// Emby item fetch — the chosen `MediaSource` JSON, the parsed
...
class EmbyPlaybackBundle {
  ...
  /// `embyMediaSourceToMediaSourceInfo` for track parsing.
  ...
  /// `MediaSourceId=` even when it equals the item id; otherwise Emby
  ...
  /// behavior when Emby's source id differs from the item id, and also pin
