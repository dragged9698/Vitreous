...
/// Emby sprite-sheet scrub thumbnails. Picks the best width from the
...
class EmbyTrickplayService implements ScrubPreviewSource {
  ...
  static EmbyTrickplayService? create({
...
/// [EmbyTrickplayService.tileLocationFor] for unit tests.
