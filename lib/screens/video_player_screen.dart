...
import '../services/emby_playback_debug.dart';
...
import 'video_player/widgets/desktop_pip_chrome.dart';
...
class VideoPlayerScreenState extends State<VideoPlayerScreen> with WidgetsBindingObserver, MountedSetStateMixin {
  ...
  void dispose() {
    ...
    if (DesktopPipService.isActive.value) {
      unawaited(DesktopPipService.exit());
    }
