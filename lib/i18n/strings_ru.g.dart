...
class _TranslationsSettingsRu extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Поддержать Vitreous';
	...
	@override String get importSettingsInvalidFile => 'Этот файл не является действительным экспортом настроек Vitreous';
	...
	@override String get startInFullscreenDescription => 'Открывать Vitreous в полноэкранном режиме при запуске';
	...
	@override String get startupSectionDescription => 'Выберите, какой раздел Vitreous открывает при запуске';
...
class _TranslationsProfilesRu extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addVitreousProfile => 'Добавить профиль Vitreous';
...
class _TranslationsConnectionsRu extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Добавьте или удалите URL для ${serverName}. Vitreous будет использовать доступный URL с минимальной задержкой.';
}
...
class _TranslationsTraktRu extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Vitreous перестанет отправлять события в Trakt. Можно подключить снова в любое время.';
	...
	@override String get watchedSyncDescription => 'Когда вы отмечаете элементы как просмотренные в Vitreous, они отмечаются и в Trakt.';
}
...
class _TranslationsTrackersRu extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Vitreous перестанет обновлять ${service}. Подключите снова в любое время.';
...
class _TranslationsCompanionRemotePairingRu extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Устройства Vitreous с тем же аккаунтом Plex появятся здесь';
	...
	@override String get noDevicesHint => 'Откройте Vitreous на компьютере и используйте тот же WiFi';
	...
	@override String get sessionNotFound => 'Устройство не найдено. Убедитесь, что Vitreous запущен на хосте.';
...
class _TranslationsTrackersDeviceCodeRu extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Активируйте Vitreous в ${service}';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Поддержать Vitreous',
			...
			'settings.importSettingsInvalidFile' => 'Этот файл не является действительным экспортом настроек Vitreous',
			...
			'settings.startInFullscreenDescription' => 'Открывать Vitreous в полноэкранном режиме при запуске',
			...
			'settings.startupSectionDescription' => 'Выберите, какой раздел Vitreous открывает при запуске',
			...
			'profiles.addVitreousProfile' => 'Добавить профиль Vitreous',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Добавьте или удалите URL для ${serverName}. Vitreous будет использовать доступный URL с минимальной задержкой.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Устройства Vitreous с тем же аккаунтом Plex появятся здесь',
			...
			'companionRemote.pairing.noDevicesHint' => 'Откройте Vitreous на компьютере и используйте тот же WiFi',
			...
			'trakt.disconnectConfirmBody' => 'Vitreous перестанет отправлять события в Trakt. Можно подключить снова в любое время.',
			...
			'trakt.watchedSyncDescription' => 'Когда вы отмечаете элементы как просмотренные в Vitreous, они отмечаются и в Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Vitreous перестанет обновлять ${service}. Подключите снова в любое время.',
			'trackers.connectFailed' => ({required Object service}) => 'Не удалось подключиться к ${service}. Попробуйте ещё раз.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Активируйте Vitreous в ${service}',
